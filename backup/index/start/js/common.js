...
var oneDate = new Date("12/11/2017 20:00:00");
...
$(".stregister").click(function() {
    $("html, body").animate({ scrollTop: $("#register").offset().top }, 1500);
});
$(".stwhatyouget").click(function() {
    $("html, body").animate({ scrollTop: $("#whatyouget").offset().top }, 1500);
});
$(".stspeaker").click(function() {
    $("html, body").animate({ scrollTop: $("#speaker").offset().top }, 1500);
});
	whatyouget
